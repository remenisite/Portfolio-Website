  ...
  return (
    <>
        ...
        <div className="space-y-6">
          ...
          <h3 className="text-[40px] font-medium font-main text-white">Let's Talk For your <span className='text-text'> Next Projects</span></h3>
          <p className="text-[20px] font-normal font-main text-white">
            Feel free to reach out to discuss a project or just say hello. I'm available via email or phone call.</p>

          {/* Highlights */}
          <ul className="space-y-2 text-[20px] font-normal font-main text-white">
